...
const SmallCrossConfigurator: React.FC<InfoProps> = ({ product }) => {
  ...
  //this is array of lego colors and the pin from SmallCrossContext
...
export default SmallCrossConfigurator;
